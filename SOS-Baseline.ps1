...
if ($args -contains "-Command" -and $args -contains "Update-ScriptHash") {
    ...
    try {
        ...
        $contentForHash = $allContent -split "`n" | Where-Object { $_ -notmatch 'validScriptHash = "8BA1C3F410F9DB8DCBBB4CA7C99FA163BB651D0FF1E2CE7CD0D6F7D3D8C4F3FA"' }
        ...
        $updatedContent = $allContent -replace 'validScriptHash = "8BA1C3F410F9DB8DCBBB4CA7C99FA163BB651D0FF1E2CE7CD0D6F7D3D8C4F3FA"', "validScriptHash = `"$newHash`""
...
$validScriptHash = "8BA1C3F410F9DB8DCBBB4CA7C99FA163BB651D0FF1E2CE7CD0D6F7D3D8C4F3FA" # This will be replaced with actual hash
...
function Test-ScriptIntegrity {
    ...
    try {
        ...
        $scriptContent = Get-Content -Path $ScriptPath | Where-Object { $_ -notmatch 'validScriptHash = "8BA1C3F410F9DB8DCBBB4CA7C99FA163BB651D0FF1E2CE7CD0D6F7D3D8C4F3FA"' }
